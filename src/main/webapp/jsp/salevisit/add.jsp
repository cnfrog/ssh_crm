...
<head>
    ...
    <LINK href="${pageContext.request.contextPath }/main/resources/web/css/Manage.css" type=text/css
          rel=stylesheet>
    <script type="text/javascript" src="${pageContext.request.contextPath }/main/resources/web/js/my.js"></script>
    <!-- 使用日期控件步骤1: 导入js和css -->
    <script type="text/javascript" src="${pageContext.request.contextPath }/main/resources/web/js/jquery-1.4.4.min.js"></script>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/main/resources/web/js/datepicker/jquery.datepick.css" type="text/css">
    <script type="text/javascript" src="${pageContext.request.contextPath }/main/resources/web/js/datepicker/jquery.datepick.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath }/main/resources/web/js/datepicker/jquery.datepick-zh-CN.js"></script>
    <script type="text/javascript">
...
<FORM id=form1 name=form1
    ...
    <!-- 隐藏域回显当前编辑的拜访记录id -->
    <input type="hidden" name="updateVisitId" value="<s:property value="#saleVisit.visit_id"/>"/>
    ...
    <TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
        ...
        <TR>
                    ...
                    <TR>
                        ...
                        <td>
                            <input type="hidden" name="customer.cust_id" style="WIDTH: 180px" id="cust_id"
                                   value="<s:property value="#saleVisit.customer.cust_id" />"/>
                            <input type="text" style="WIDTH: 180px" id="cust_name"
                                   value="<s:property value="#saleVisit.customer.cust_name" />"/>
                        ...
                        <td>
                            <INPUT class=textbox id="visit_time" type="text"
                                   ...
                                   value="<s:property value="#saleVisit.visit_time_s" />">
                        </td>
                    </TR>
                    ...
                    <TR>
                        ...
                        <td>
                            <INPUT class=textbox type="text"
                                   ...
                                   value="<s:property value="#saleVisit.visit_interviewee" />">
                        </td>
                        <td>拜访地址：</td>
                        <td>
                            <INPUT class=textbox type="text"
                                   style="WIDTH: 180px" maxLength=50 name="visit_addr"
                                   value="<s:property value="#saleVisit.visit_addr" />">
                        </td>
                    </TR>
            ...
            <TD width=15 background="${pageContext.request.contextPath }/main/resources/web/images/new_023.jpg">
                <IMG src="${pageContext.request.contextPath }/main/resources/web/images/new_023.jpg" border=0></TD>
        </TR>
        </TBODY>
    </TABLE>
    <TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
