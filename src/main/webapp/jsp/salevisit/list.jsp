                            ...
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    ...
                                    <TD>
                                        ...
                                        <INPUT class=textbox style="WIDTH: 80px" maxLength=50 name="cust_name"
                                               id="cust_name" value="${param['cust_name']}">
                            ...
                            <s:iterator value="#pageBean.list">
                                <TR
                                    ...
                                    <TD>
                                        ...
                                        &nbsp;&nbsp;
                                        <a href="javascript:void(0)" onclick="deleteConfirm('<s:property
                                                value="cust_name"/>','${pageContext.request.contextPath }/CustomerAction_delete?cust_id=
                                            <s:property value="cust_id"/>');">删除</a>
                                    </TD>
                                </TR>
                            </s:iterator>
