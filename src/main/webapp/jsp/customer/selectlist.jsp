...
<head>
    ...
    <LINK href="${pageContext.request.contextPath }/main/resources/web/css/Manage.css" type=text/css rel=stylesheet>
                ...
                <TR>
                    <TD><SPAN id=pagelink>
											<DIV
												...
												,每页显示	<%-- chagePageSize($('#pageSizeSelect option').filter(':selected').val())--%>
												...
												[<A href="javaScript:void(0)"
                                                    onclick="chagePage(<s:property value='#pageBean.currentPage-1'/>)">前一页</A>]
												<B>${page}</B>
												[<A href="javaScript:void(0)"
                                                    onclick="chagePage(<s:property value='#pageBean.currentPage+1'/>)">后一页</A>]
												到
